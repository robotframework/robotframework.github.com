...
const promiseCollections = loadLibrary('https://robotframework.org/robotframework/latest/libdoc/Collections.json')
...
(async() => {
  await promiseBuiltIn
  await promiseCollections
